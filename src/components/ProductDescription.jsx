...
export default class ProductDetails extends Component {
  ...
  render() {
    ...
    return (
      <div className="description text-center text-lg-start">
        <div className="mb-3">
        ...
        <div className="info">
          ...
          <div className="rating d-flex justify-content-center justify-content-lg-start align-items-center mb-3">
          ...
          <div className="actions d-flex align-items-center gap-lg-5">
